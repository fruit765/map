...
$(document).ready(function(){
    ...
    $('.header .mobile-btn').click(function(){
        ...
        if ($(this).hasClass('open')) {
            ...
            height = $('.header .logo').outerHeight(true) + $('.header .menu').outerHeight(true) + $('.header #get-call').outerHeight(true) + 'px';
        ...
        $(this).parent().children('.logo, .menu, #get-call').stop().animate(
