...
<html lang="en" ng-app="myApp">
  ...
  <body ng-controller="myCtrl">
    ...
    <div class="map-sidebar-wrapper">
      ...
      <div class="sidebar">
        ...
        <div class="sidebar__items sidebar__items_shops">
          <div ng-repeat="cityShop in cityShops" class="sidebar__item" shop-id="{{cityShop.lng}},{{cityShop.lat}}">
    ...
    <noscript><div><img src="https://mc.yandex.ru/watch/71099074" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    <!-- /Yandex.Metrika counter -->
  </body>
</html>